...
function library:Watermark(text)
    ...
    bar.BackgroundColor3 = Color3.fromRGB(238, 84, 172)
    ...
    waterText.Text = text
    waterText.TextColor3 = Color3.fromRGB(234, 198, 198)
...
function library:Introduction()
    ...
    hashLogo.Image = "http://www.roblox.com/asset/?id=13750528623"
